 ...
 * @param {number} mvid mv 的 id
 */
export function mvDetailInfo(mvid: number) {
  return request({
    url: '/mv/detail/info',
    method: 'get',
    params: {
 ...
 */
export function mvUrl(params: { id: number; r?: number }) {
  return request({
    url: '/mv/url',
    method: 'get',
    params
...
export function subAMV(params: { mvid: number; t?: number; timestamp?: number }) {
...
export function likeAMV(params: { id: number; t: number; type: number }) {
  return request({
    url: '/resource/like',
    method: 'get',
    params
