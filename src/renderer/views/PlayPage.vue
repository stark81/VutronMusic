<template>
  <div>
    <transition name="slide-up">
      <div v-if="showLyrics" class="player-container" :data-theme="activeBG.color">
        <BackgroundPage />
        <div
          class="buttons-icons"
...
watch(
  () => showSenseSelector.value && activeTheme.value.theme.activeLayout,
  () => {
    tabIdx.value = 0
    titleIdx.value = 0
  }
